...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="A folder containing the training data of instance images. OR a folder containing subfolders of training images for each multiinstance.",
    )
    parser.add_argument(
        "--class_data_dir",
        type=str,
        default=None,
        required=False,
        help="A folder containing the training data of class images. OR a folder containing subfolders of training data for each multiinstance's class images.",
    )
    parser.add_argument(
        "--instance_prompt",
        type=str,
...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        for idx_instance,(instance_image_dir, class_image_dir) in enumerate(zip(lst_instance_dir,lst_class_dir)):
            lst_imagepath_instance = list(Path(instance_image_dir).iterdir())
            lst_imagepath_class = list(Path(class_image_dir).iterdir())
